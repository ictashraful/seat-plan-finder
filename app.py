...
<div style="background-color: #fff7ed; padding: 15px; border-radius: 10px; border: 1px solid #ffedd5;">
    ...
    <ul style="margin: 5px 0 0 0; color: #9a3412; font-size: 13px;">
        <li>পরীক্ষা শুরুর অন্তত <b>৩০ মিনিট আগে</b> অবশ্যই নির্দিষ্ট কক্ষে আসন গ্রহণ করতে হবে।</li>
        <li>পরীক্ষাকক্ষে মোবাইল ফোন, স্মার্ট ওয়াচ বা যেকোনো ধরনের ইলেকট্রনিক ডিভাইস আনা সম্পূর্ণ <b>নিষেধ</b>।</li>
        <li>অবশ্যই মূল <b>প্রবেশপত্র (Admit Card)</b> এবং <b>রেজিস্ট্রেশন কার্ড (Registration Card)</b> সঙ্গে আনতে হবে।</li>
        <li>পরীক্ষাকক্ষে শৃঙ্খলা পরিপন্থী যেকোনো কাজের জন্য সংশ্লিষ্ট পরীক্ষার্থীর পরীক্ষা বাতিলসহ আইনানুগ ব্যবস্থা গ্রহণ করা হবে।</li>
    </ul>
</div>
""", unsafe_allow_html=True)

st.markdown("<br><hr><p style='text-align: center; color: #94a3b8; font-size: 12px;'>© 2026 | Developed for Narsingdi Government Polytechnic Institute| Developed by Exam Control Room Team of NGPI</p>", unsafe_allow_html=True)